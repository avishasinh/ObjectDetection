...
function draw(){
    ...
    for(var i = 0; i < objects.length; i++){
        ...
        document.getElementById("numbers").innerHTML = "There is one big object in this image and the cocossd model has identified 1 of those images"
    }
}
